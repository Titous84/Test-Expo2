 ...
 */
class DeleteTeamsInfos
{	
	
	/**
	 * @var TeamsListService Dépôt liée au service TeamsListService
	 */
    ...
    /**
     * Constructeur de la classe DeleteTeamsInfos
     *
	...
	public function __invoke(Request $request, Response $response, $args): ResponseInterface
	{
		...
		$teamsList = $this->teamsListService->delete_teams_infos($request->getParsedBody());
