...
/**
 * Action qui permet d'enregistrer les plages horaire (heures de passage)
 * @author Xavier Houle
 */
class SaveTimeSlotsActions
{
	...
	public function __invoke(Request $request, Response $response, $args): ResponseInterface
	{
		...
		$result = $this->standService->save_time_slots($request->getParsedBody());
        $response->getBody()->write($result->to_json());
		return $response->withStatus($result->get_http_code());
	}
}
